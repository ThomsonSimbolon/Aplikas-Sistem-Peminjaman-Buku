                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="proses_login.php" method="post">
                                        ...
                                        <button type="submit" name="login"
                                            class="btn bg-gradient-success btn-success bg-success shadow btn-user btn-block text-white z-1000">
                                            Login
                                        </button>
                                    </form>
                                    <hr>
                            ...
                            <div class="col-lg-6 d-none d-lg-block login-form">
                                <img src="images/card.png" class="p-2" width="100%" height="auto" alt="Thom">
                            </div>
                        </div>
                    </div>
                </div>
